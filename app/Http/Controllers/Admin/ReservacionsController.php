...
var_dump($h_inicio); echo "<br>";
        ...
        $val_reservation= DB::connection('odbc')->selectOne("SELECT id FROM reservaciones WHERE id_seccion = ".$request->sala_de_juntas." AND fecha_inicio = convert(varchar, '".$f_inicio."', 103) AND hora_inicio='".$h_inicio."' ");
